...
# Languages used  
 ...
 - PHP/MySQL: For organization, monitoring and mapping of data, and most importantly user registration.
 - CLI (Command line interface): Testing and deploying the system through Django, and for inputting data into the dynamically allocating table.  Essentially used to interface with the server that hosts the website and to monitor data storage. 
